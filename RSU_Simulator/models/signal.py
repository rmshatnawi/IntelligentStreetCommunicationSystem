...
# Project:  Intelligent Street Communication System (ISCS)
# File:     RSU_Simulator/models/signal.py
# Purpose:  Builds the detection event sent to the server.
# Updates (Jun 2026)
#   - timestamp is now passed in so events reflect the
#     simulated time the vehicle crossed each RSU.
# ============================================================
...
def build_signal(rsu_id, segment, speed, vehicle_count,
                 direction="Unknown", plate_number="Unknown",
                 lat=None, lng=None, timestamp=None) -> dict:
    return {
        "event_id":      str(uuid.uuid4()),
        "rsu_id":        rsu_id,
        "segment":       segment,
